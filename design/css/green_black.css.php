...
img {border:0px;}
html {
background-image:url(../themes/green_black/pic/hin/5.jpg); 
background-repeat:repeat-x; 
background-position:top center;
background-color : #ffffff;
}
#xbody {
background-image:url(../themes/green_black/pic/hin/4.jpg); 
background-repeat:repeat-x; 
background-position:top center;
background-color : #ffffff;
width:800px;
...
.hallo {display:none;}
h2 {
border-bottom:1px solid #36a736;
margin-bottom : 5px;
font-size : 20px;
}
#f {
...
#f a:link {color:#36a736; text-decoration:none;}
#f a:visited {color:#36a736; text-decoration:none;}
#f a:focus {color:#36a736; text-decoration:none;}
#f a:hover {color:#36a736; text-decoration:underline;}
#f a:active {color:#36a736; text-decoration:none;}
#p {
position:static;
float:right;
font-size: 14px;
...
#p a:hover {text-decoration:none; opacity: 0.7;}
...
.l p {color:#000000; text-decoration:none; background-image:url(../themes/green_black/pic/hin/5.jpg); 
background-repeat:repeat-x; 
background-position:top center; border-radius: 5px;
padding: 5px 5px 5px 5px;
text-shadow: 0 0 0.8em #ffffff, 0 0 0.5em #ffffff, 0 0 0.2em #ffffff;
display:block;
margin-bottom:8px;}
.l a:link {color:#000000; text-decoration:none; background-image:url(../themes/green_black/pic/hin/3.jpg); 
background-repeat:repeat-x; 
...
display:block;
margin-bottom:8px;}
.l a:visited {text-decoration:none;}
.l a:focus {text-decoration:none;}
.l a:hover {text-decoration:underline; opacity: 0.7;}
.l a:active {text-decoration:none;}
.sp { box-shadow: 0px 0px 5px #000000;}
#hn {
position:static;
background-image:url(../themes/green_black/pic/hin/t.png); 
