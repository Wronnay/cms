...
background-image : url(../themes/Simple-SkyBlue/images/hintergrund.png);
...
width : 190px;
float:right;
background-image : url(../themes/Simple-SkyBlue/images/navi.png);
...
display:block;
color:#ffffff;
background-image : url(../themes/Simple-SkyBlue/images/tra.png);
...
width : 756px;
float:left;
background-image : url(../themes/Simple-SkyBlue/images/box.png);
background-repeat : repeat-x;
background-position : center top;
