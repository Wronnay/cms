...
$codebody .= '<div style="padding:10px; border-radius: 15px; box-shadow:inset 0px 0px 15px #cccccc;">
<b>'.l44.':</b> 
<a href="index.php?type=messages&action=box"> '.l45.'</a> | 
<a href="index.php?type=messages&action=outbox"> '.l46.'</a> | 
<a href="index.php?type=messages&action=write"> '.l47.'</a>
</div>
