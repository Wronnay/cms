...
?>
  <rss version="2.0">
    <channel>
      <title><?php echo l298; ?> - <?php echo $site_title; ?></title>
      <link><?php echo $site_url; ?></link>
      <description><?php echo $site_title; ?> - <?php echo l299; ?></description>
...
echo nocss($rsssig);
?> ]]></description>
        <link><?php echo nocss($site_url); ?>/user.php?id=<?php echo nocss($_GET['id']); ?></link>
        <guid><?php echo nocss($site_url); ?>/user.php?id=<?php echo nocss($_GET['id']); ?></guid>
